...
def fuzzy_inference(temp, humidity):
    ...
    fan_low_value = rule1 * fan_speed_membership(25)[0] + rule2 * fan_speed_membership(50)[0]
    fan_high_value = rule1 * fan_speed_membership(50)[1] + rule2 * fan_speed_membership(75)[1]
